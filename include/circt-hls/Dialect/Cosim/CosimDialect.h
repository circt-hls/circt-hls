//===- CosimDialect.h - Cosim dialect declaration ---------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the Cosim MLIR dialect.
//
//===----------------------------------------------------------------------===//

#ifndef CIRCT_HLS_DIALECT_COSIM_COSIMDIALECT_H
#define CIRCT_HLS_DIALECT_COSIM_COSIMDIALECT_H
